...
국내에 이륜차를 출시할 때는 [배출가스·소음 등 해당 차량에 적용되는 인증](https://www.keco.or.kr/web/lay1/S1T167C1024/contents.do)을 거칩니다. 이 과정에서 차명과 형식, 제작·수입사 정보가 남기 때문에, 인증 기록을 판매 모델별로 정리하면 국내 정발 기종 목록의 바탕으로 쓸 수 있습니다.
