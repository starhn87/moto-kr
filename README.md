...
- 비용·시간 상한은 단계당 대상 20개/입력 60,000자, API 요청 1회, 웹 도구 호출 12회, 출력(추론 포함) 8,000토큰, 8분입니다. 대상이 없으면 API를 호출하지 않습니다. 상한 초과·검색 실패·누락 시 자동 확정을 건너뛰며 수동 검토가 필요합니다. 근거 artifact는 7일 보관합니다.
